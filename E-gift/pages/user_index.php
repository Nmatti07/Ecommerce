...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Swaraj and Nikhil." data-placement="bottom" target="">
                    E-Gift Website
                </a>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="white">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/gift1.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/img/joyinside.png" alt="Circle Image" class="rounded-circle">
                        <br><br>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="https://code-projects.org/"></a>Swaraj and Nikhil</li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
