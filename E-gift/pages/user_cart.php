      ...
      <table class="table table-condensed table-bordered">
          ...
          ?>
            ...
            ?>
                ...
                <button  type="submit" id="" onclick="return confirm('Are you sure you want to Order?')" name="submit" class="btn btn-success btn-round pull-right" data-toggle="modal" data-target="#myModal">
                <i class="now-ui-icons shopping_bag-16"></i> Confirm Order</button> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="belgavi City">belgavi</option>
                      <option value="banglore City">banglore</option>
                      <option value="Las Pinas City">hubli</option>
                      <option value="Makati City">dharwad</option>
