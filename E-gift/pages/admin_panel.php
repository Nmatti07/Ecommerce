...
<body class="profile-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Swaraj and Nikhil." data-placement="bottom" target="">
                    E-Gift
                </a>
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/gift1.jpg');"></div>
                <div class="container">
                                      ...
                                      <br><br>
                                        <table id="" class="table table-bordered table-striped">
                                          <thead>
                                            ...
                                            <?php
                                                $query=mysqli_query($dbconn,"SELECT * FROM logs NATURAL JOIN users ORDER BY date DESC")or die(mysqli_query());
                                      ...
                                      <br><br>
                                        <table id="" class="table table-bordered table-striped">
                                          <thead>
                                            ...
                                            <?php
                                                $query=mysqli_query($dbconn,"SELECT * FROM logs NATURAL JOIN admin ORDER BY date DESC")or die(mysqli_query());
                                                while($row=mysqli_fetch_array($query)){ 
                                            ?>
                                          <tr>
                                            <td><?php echo $row['firstname']." ".$row['lastname']." ".$row['action']." last ".$row['date'];?></td>
        ...
        <footer class="footer" data-background-color="black">
           <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Swaraj and Nikhil.
                </div>
            </div>
        </footer>
    </div>
